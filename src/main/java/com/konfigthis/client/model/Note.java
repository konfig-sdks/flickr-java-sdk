...
public class Note {
  ...
  **/
   ...
   * @return the Note instance itself
   */
  public Note putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, note.description)&&
        Objects.equals(this.additionalProperties, note.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Note.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Note>() {
           ...
           public Note read(JsonReader in) throws IOException {
             ...
             Note instance = thisAdapter.fromJsonTree(jsonObj);
