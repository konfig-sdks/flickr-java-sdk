...
public class GroupBlast {
  ...
  **/
   ...
   * @return the GroupBlast instance itself
   */
  public GroupBlast putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.content, groupBlast.content) &&
        ...
        Objects.equals(this.additionalProperties, groupBlast.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(content, dateBlastAdded, userId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroupBlast
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroupBlast.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GroupBlast>() {
           ...
           public GroupBlast read(JsonReader in) throws IOException {
             ...
             GroupBlast instance = thisAdapter.fromJsonTree(jsonObj);
