...
public class ContextPhotos {
  ...
  private List<ContextPhoto> photos = null;
  ...
  **/
   ...
   * @return the ContextPhotos instance itself
   */
  public ContextPhotos putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.photos, contextPhotos.photos)&&
        Objects.equals(this.additionalProperties, contextPhotos.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContextPhotos
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContextPhotos.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("photos") != null && !jsonObj.get("photos").isJsonNull()) {
        ...
        if (jsonArrayphotos != null) {
          ...
          for (int i = 0; i < jsonArrayphotos.size(); i++) {
            ContextPhoto.validateJsonObject(jsonArrayphotos.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContextPhotos>() {
           ...
           public ContextPhotos read(JsonReader in) throws IOException {
             ...
             ContextPhotos instance = thisAdapter.fromJsonTree(jsonObj);
