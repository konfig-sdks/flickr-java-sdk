...
public class PhotoUrls {
  ...
  **/
   ...
   * @return the PhotoUrls instance itself
   */
  public PhotoUrls putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, photoUrls.url)&&
        Objects.equals(this.additionalProperties, photoUrls.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PhotoUrls
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PhotoUrls.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("url") != null && !jsonObj.get("url").isJsonNull()) {
        ...
        if (jsonArrayurl != null) {
          ...
          for (int i = 0; i < jsonArrayurl.size(); i++) {
            URL.validateJsonObject(jsonArrayurl.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PhotoUrls>() {
           ...
           public PhotoUrls read(JsonReader in) throws IOException {
             ...
             PhotoUrls instance = thisAdapter.fromJsonTree(jsonObj);
