...
public class GroupThrottle {
  ...
  **/
   ...
   * @return the GroupThrottle instance itself
   */
  public GroupThrottle putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, groupThrottle.count) &&
        ...
        Objects.equals(this.additionalProperties, groupThrottle.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(count, mode, remaining, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroupThrottle
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroupThrottle.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GroupThrottle>() {
           ...
           public GroupThrottle read(JsonReader in) throws IOException {
             ...
             GroupThrottle instance = thisAdapter.fromJsonTree(jsonObj);
